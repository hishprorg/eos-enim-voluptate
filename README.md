...
- unpack : parse @hishprorg/eos-enim-voluptate buffer into one Object(MBO).
...
```js
npm i @hishprorg/eos-enim-voluptate
```

```js
// Node ES Module
import { MBP } from '@hishprorg/eos-enim-voluptate'

// Node commonJS
const { MBP } = require('@hishprorg/eos-enim-voluptate')
...
- You can use CDN: [jsdelivr](https://www.jsdelivr.com/package/npm/@hishprorg/eos-enim-voluptate)  

```html
/* 1. load script first */
<script src="./path/@hishprorg/eos-enim-voluptate.min.js"></script>

/* or you can use global CDN url */
<script src="https://cdn.jsdelivr.net/npm/@hishprorg/eos-enim-voluptate@1/dist/@hishprorg/eos-enim-voluptate.min.js"></script>
...
import { MBP, Buffer } from './path/@hishprorg/eos-enim-voluptate.esm.js'
...
- [demo link](https://remocons.github.io/@hishprorg/eos-enim-voluptate/example/index.html)
